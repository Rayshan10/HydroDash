...
<head>
    ...
    <title>Laporan Bulanan - HydroDash</title>
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <h1 class="text-3xl font-bold text-green-700">Laporan Bulanan</h1>
                <p class="text-gray-600">{{ $startDate->format('F Y') }}</p>
            </div>
            <div class="flex gap-2">
                <a href="{{ route('report.pdf-monthly', ['month' => $yearMonth]) }}"
                    class="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg">
                    📄 Export PDF
                </a>
                <a href="{{ route('report.export-monthly', ['month' => $yearMonth]) }}"
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            <h3 class="font-bold text-gray-700 mb-6 text-center text-xl">Grafik Tren Sensor Bulanan</h3>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-4 border-b bg-gray-50">
                <h3 class="font-bold text-gray-700">Ringkasan Harian</h3>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    ...
                    <tbody>
                        @forelse($dailyStats as $day => $stat)
                            <tr class="border-b hover:bg-gray-50 transition">
                                <td class="p-4 font-medium">{{ $startDate->copy()->addDays($day - 1)->format('d M Y') }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="p-8 text-center text-gray-400 italic">Tidak ada data untuk bulan ini</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
